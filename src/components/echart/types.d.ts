...
declare type WithThisType<Func extends (...args: any) => any, This> = (
  this: This,
...
declare function merge<T extends Dictionary<any>, S extends Dictionary<any>>(
  target: T,
  source: S,
  overwrite?: boolean,
): T & S;
...
declare function defaults<T extends Dictionary<any>, S extends Dictionary<any>>(
  target: T,
  source: S,
  overlay?: boolean,
): T & S;
...
declare type Bind2<F, Ctx, T1> = F extends (this: Ctx, a: T1, ...args: infer A) => infer R
  ? (...args: A) => R
  : unknown;
declare type Bind3<F, Ctx, T1, T2> = F extends (this: Ctx, a: T1, b: T2, ...args: infer A) => infer R
  ? (...args: A) => R
  : unknown;
declare type Bind4<F, Ctx, T1, T2, T3> = F extends (this: Ctx, a: T1, b: T2, c: T3, ...args: infer A) => infer R
  ? (...args: A) => R
  : unknown;
declare type Bind5<F, Ctx, T1, T2, T3, T4> = F extends (
  this: Ctx,
  a: T1,
  b: T2,
  c: T3,
...
declare type Curry3<F, T1, T2, T3> = F extends (a: T1, b: T2, c: T3, ...args: infer A) => infer R
  ? (...args: A) => R
  : unknown;
declare type Curry4<F, T1, T2, T3, T4> = F extends (a: T1, b: T2, c: T3, d: T4, ...args: infer A) => infer R
  ? (...args: A) => R
  : unknown;
...
declare function curry<F extends CurryFunc, T1 extends Parameters<F>[0], T2 extends Parameters<F>[1]>(
  func: F,
  a: T1,
  b: T2,
): Curry2<F, T1, T2>;
...
declare type EventCallbackSingleParam<EvtParam = any> = EvtParam extends any
  ? (params: EvtParam) => boolean | void
  : never;
declare type EventCallback<EvtParams = any[]> = EvtParams extends any[]
...
declare const TRANSFORMABLE_PROPS: readonly [
  'x',
  'y',
  'originX',
  'originY',
...
declare const PRIMARY_STATES_KEYS: [
...
declare type ElementCalculateTextPosition = (
...
declare class DataDiffer<CTX = unknown> {
   ...
   */
  constructor(
    oldArr: ArrayLike$1<unknown>,
    newArr: ArrayLike$1<unknown>,
...
declare type TaskResetCallback<Ctx extends TaskContext> = (
  this: Task<Ctx>,
  context: Ctx,
...
declare type TaskProgressCallback<Ctx extends TaskContext> = (
  this: Task<Ctx>,
...
interface AxisBaseModel<T extends AxisBaseOptionCommon = AxisBaseOptionCommon>
...
declare const dimPermutations: readonly [
  readonly ['x0', 'y0'],
  readonly ['x1', 'y0'],
  readonly ['x1', 'y1'],
  readonly ['x0', 'y1'],
...
interface BaseBarSeriesOption<StateOption, ExtraStateOption extends StatesMixinBase = DefaultStatesMixin>
...
declare type PolarBarLabelPosition =
...
interface CustomDisplayableOption
...
declare type CreateCustomBuitinPathOption<T extends keyof BuiltinShapes> = T extends any
  ? CustomBuitinPathOption<T>
  : never;
...
declare function makeStyleMapper(
  properties: readonly string[][],
  ignoreParent?: boolean,
): (model: Model, excludes?: readonly string[], includes?: readonly string[]) => PathStyleProps;
...
interface VisualMapOption<T extends VisualOptionBase = VisualOptionBase>
  extends ComponentOption,
    BoxLayoutOptionMixin,
    BorderOptionMixin {
  mainType?: 'visualMap';
...
declare class SeriesData<HostModel extends Model = Model, Visual extends DefaultDataVisual = DefaultDataVisual> {
  ...
  mapArray<Ctx, Cb extends MapArrayCb1<Ctx>>(
    dims: DimensionLoose,
    cb: Cb,
    ctx?: Ctx,
    ctxCompat?: Ctx,
  ...
  mapArray<Ctx, Cb extends MapArrayCb2<Ctx>>(
 ...
 * animation starts, unless you know what you are doing.
 */
declare function initProps<Props extends ElementProps>(
  el: Element<Props>,
  props: Props,
  animatableModel?: Model<AnimationOptionMixin>,
  dataIndex?: AnimateOrSetPropsOption['dataIndex'] | AnimateOrSetPropsOption['cb'] | AnimateOrSetPropsOption,
...
declare type OptionDataItemOriginal<VAL extends OptionDataValue = OptionDataValue> =
  | VAL
  | VAL[]
  | OptionDataItemObject<VAL>;
declare type OptionSourceDataOriginal<
  VAL extends OptionDataValue = OptionDataValue,
  ORIITEM extends OptionDataItemOriginal<VAL> = OptionDataItemOriginal<VAL>,
> = ArrayLike<ORIITEM>;
...
declare type AreaStyleProps = Pick<
  PathStyleProps,
  'fill' | 'shadowBlur' | 'shadowOffsetX' | 'shadowOffsetY' | 'opacity' | 'shadowColor'
>;
...
declare type LabelRectRelatedOption = Pick<
  LabelOption,
  'align' | 'verticalAlign' | 'padding' | 'lineHeight' | 'baseline' | 'rich' | 'width' | 'height' | 'overflow'
> &
  LabelFontOption;
...
declare class ECharts extends Eventful<ECEventDefinition> {
   ...
   */
  getVisual(
    finder: ModelFinder$1,
    visualType: string,
  ): string | number | number[] | PatternObject | LinearGradientObject | RadialGradientObject;
  /**
...
declare function registerUpdateLifecycle<T extends keyof LifecycleEvents>(
  name: T,
 ...
 */
declare function throttle<T extends ThrottleFunction>(
  fn: T,
  delay?: number,
  debounce?: boolean,
...
declare function enableDataStack(
  ...
  'stackedDimension' | 'stackedByDimension' | 'isStackedByIndex' | 'stackedOverDimension' | 'stackResultDimension'
>;
 ...
 */
declare function createDimensions(
...
declare type GetDependencies<MainType extends string> = GetDependency<
  Dependencies[Extract<MainType, DependenciesKeys>]
>;
...
interface MarkPointDataItemOption
  extends MarkPointStateOption,
...
interface LineDataItemOption
  extends SymbolOptionMixin,
    LineStateOption,
    StatesOptionMixin<LineStateOption, LineStateOptionMixin> {
  name?: string;
  value?: LineDataValue;
}
...
interface PieDataItemOption
  extends OptionDataItemObject<OptionDataValueNumeric>,
    PieStateOption,
 ...
 */
interface TreeSeriesLeavesOption
  extends TreeSeriesStateOption,
    StatesOptionMixin<TreeSeriesStateOption, TreeStatesMixin> {}
interface TreeSeriesOption
  extends SeriesOption<TreeSeriesStateOption, TreeStatesMixin>,
...
interface TreemapSeriesLevelOption
  extends TreemapSeriesVisualOption,
    TreemapStateOption,
    StatesOptionMixin<TreemapStateOption, ExtraStateOption$1> {
  color?: ColorString[] | 'none';
  decal?: DecalObject[] | 'none';
}
interface TreemapSeriesNodeItemOption
  extends TreemapSeriesVisualOption,
    TreemapStateOption,
    StatesOptionMixin<TreemapStateOption, ExtraStateOption$1> {
  id?: OptionId;
...
interface GraphEdgeItemOption
  extends GraphEdgeStateOption,
...
interface GraphCategoryItemOption
  extends SymbolOptionMixin,
    GraphNodeStateOption,
    StatesOptionMixin<GraphNodeStateOption, GraphNodeStatesMixin> {
  name?: string;
...
interface GaugeSeriesOption
  extends SeriesOption<GaugeStateOption, GaugeStatesMixin>,
...
interface FunnelDataItemOption
  extends FunnelStateOption,
    StatesOptionMixin<FunnelStateOption, FunnelStatesMixin>,
    OptionDataItemObject<OptionDataValueNumeric> {
  itemStyle?: ItemStyleOption & {
    width?: number | string;
    height?: number | string;
...
interface ParallelSeriesDataItemOption
  extends ParallelStateOption,
    StatesOptionMixin<ParallelStateOption, ParallelStatesMixin> {
  value?: ParallelSeriesDataValue;
}
interface ParallelSeriesOption
  extends SeriesOption<ParallelStateOption<CallbackDataParams>, ParallelStatesMixin>,
...
interface SankeyNodeItemOption
  extends SankeyNodeStateOption,
    StatesOptionMixin<SankeyNodeStateOption, ExtraStateOption$2>,
    OptionDataItemObject<OptionDataValue> {
  id?: string;
  localX?: number;
  localY?: number;
...
interface SankeyEdgeItemOption
  extends SankeyEdgeStateOption,
    StatesOptionMixin<SankeyEdgeStateOption, ExtraStateOption$2>,
    GraphEdgeItemObject<OptionDataValueNumeric> {
  focusNodeAdjacency?: FocusNodeAdjacency;
  edgeLabel?: SeriesLabelOption;
}
...
interface SankeySeriesOption
  extends SeriesOption<SankeyBothStateOption<CallbackDataParams>, ExtraStateOption$2>,
...
interface CandlestickDataItemOption
  extends CandlestickStateOption,
    StatesOptionMixin<CandlestickStateOption, ExtraStateOption$4> {
...
interface EffectScatterDataItemOption
  extends SymbolOptionMixin,
...
interface SunburstSeriesNodeItemOption
  extends SunburstStateOption<SunburstDataParams>,
...
interface SunburstSeriesLevelOption
  extends SunburstStateOption<SunburstDataParams>,
    StatesOptionMixin<SunburstStateOption<SunburstDataParams>, SunburstStatesMixin> {
  radius?: (number | string)[];
  /**
...
interface SunburstSeriesOption
  extends SeriesOption<SunburstStateOption<SunburstDataParams>, SunburstStatesMixin>,
...
interface GraphicComponentBaseElementOption
  extends Partial<
      Pick<Element, TransformProp | 'silent' | 'ignore' | 'textConfig' | 'draggable' | ElementEventNameWithOn>
    >,
    /**
...
interface GraphicComponentDisplayableOption
  extends GraphicComponentBaseElementOption,
...
declare type GraphicComponentElementOption =
...
export {
  ...
  install$2 as install$1,
  install$b as install$10,
  install$c as install$11,
  install$d as install$12,
  install$e as install$13,
  install$f as install$14,
  install$g as install$15,
  install$h as install$16,
  install$i as install$17,
  install$j as install$18,
  install$k as install$19,
  install$3 as install$2,
  install$l as install$20,
  install$m as install$21,
  install$o as install$22,
  install$p as install$23,
  install$q as install$24,
  install$r as install$25,
  install$s as install$26,
  install$t as install$27,
  install$u as install$28,
  install$v as install$29,
  install$4 as install$3,
  install$w as install$30,
  install$x as install$31,
  install$y as install$32,
  install$z as install$33,
  install$A as install$34,
  install$n as install$35,
  install$B as install$36,
  install$C as install$37,
  install$D as install$38,
  install$E as install$39,
  install$5 as install$4,
  install$F as install$40,
  install$G as install$41,
  install$H as install$42,
  install$I as install$43,
  install$J as install$44,
  install$K as install$45,
  install$L as install$46,
  install$M as install$47,
  install$N as install$48,
  install$O as install$49,
  install$6 as install$5,
  install$P as install$50,
  install as install$51,
  install$Q as install$52,
  install$R as install$53,
  install$7 as install$6,
  install$8 as install$7,
  install$9 as install$8,
  install$a as install$9,
  installLabelLayout,
...
export declare type SourceFormat =
  | typeof SOURCE_FORMAT_ORIGINAL
  | typeof SOURCE_FORMAT_ARRAY_ROWS
  | typeof SOURCE_FORMAT_OBJECT_ROWS
  | typeof SOURCE_FORMAT_KEYED_COLUMNS
...
export declare type OptionSourceData<
  VAL extends OptionDataValue = OptionDataValue,
  ORIITEM extends OptionDataItemOriginal<VAL> = OptionDataItemOriginal<VAL>,
> =
  | OptionSourceDataOriginal<VAL, ORIITEM>
  ...
  | OptionSourceDataKeyedColumns<VAL>
  | OptionSourceDataTypedArray;
export declare type OptionDataItemOriginal<VAL extends OptionDataValue = OptionDataValue> =
  | VAL
  | VAL[]
  | OptionDataItemObject<VAL>;
export declare type OptionSourceDataOriginal<
  VAL extends OptionDataValue = OptionDataValue,
  ORIITEM extends OptionDataItemOriginal<VAL> = OptionDataItemOriginal<VAL>,
> = ArrayLike<ORIITEM>;
...
export declare type OptionSourceDataKeyedColumns<VAL extends OptionDataValue = OptionDataValue> = Dictionary<
  ArrayLike<VAL>
>;
export declare type OptionSourceDataTypedArray = ArrayLike<number>;
export declare type OptionDataItem =
  | OptionDataValue
  | Dictionary<OptionDataValue>
  | OptionDataValue[]
  | OptionDataItemObject<OptionDataValue>;
...
export interface SeriesOption<StateOption = unknown, StatesMixin extends StatesMixinBase = DefaultStatesMixin>
  extends ComponentOption,
    AnimationOptionMixin,
    ColorPaletteOptionMixin,
    StatesOptionMixin<StateOption, StatesMixin> {
